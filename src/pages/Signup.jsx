    ...
    <div className="bg-gray-100 flex items-center justify-center h-screen">
        <div className="bg-white p-8 rounded shadow-md w-80">
            ...
            <div className="mb-4">
                ...
                <input type="text" name="firstname" className="mt-1 p-2 w-full border rounded-md" required {...register('firstname')}/>
            </div>

            <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700">Last Name</label>
                <input type="text" name="lastname" className="mt-1 p-2 w-full border rounded-md" requuired {...register('lastname')}/>
            </div>

            <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700">Password</label>
                <input type="password" name="user_password" className="mt-1 p-2 w-full border rounded-md" required {...register('password')}/>
            </div>
